...
'AtomSymbol': 'Atom.get_symbol()', #'PeriodicTable.ABBR',
...
#'AtomStateLifeTimeMethod': 'Atom.get_tau_ref()',
############################################################
'RadTransSpeciesRef':'RanTran.species',
...
RESTRICTABLES = {\
'AtomSymbol':'species__periodic_table__name',
#'AtomNuclearCharge':'species__atomic',
'StateEnergy':'upstate__energy',
