<?php /* Smarty version 2.6.12, created on 2016-07-27 11:36:48
         compiled from view/en/index.tpl */ ?>
...
<b>The system enables a some main types of uses:</b>
        			...
        			<ul>
						<li>
							<span>
                        obtain <b>information on levels</b> of one or more elements in a tabular form. Currently, the system contains information on <?php echo $this->_tpl_vars['level_count']; ?>
 levels</span>
						</li>
                    
						<li>
							 obtain <b>information on transitions</b> 
	of elements in a table form. Currently, the system contains information on <?php echo $this->_tpl_vars['transition_count']; ?>
 transitions. 
						</li>
