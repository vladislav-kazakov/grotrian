<?php /* Smarty version 2.6.12, created on 2016-07-27 11:22:22
         compiled from view/element_picker.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'view/element_picker.tpl', 16, false),array('modifier', 'capitalize', 'view/element_picker.tpl', 20, false),)), $this); ?>
...
px;"><div class="head"><?php echo $this->_sections['bar']['index']; ?>
		...
		<div class="empty" style="width:85px; left:0px; margin-top:240px;"><div class="head"></div><?php echo $this->_tpl_vars['l10n']['Lanthanide']; ?>
</div>
		<div class="empty" style="width:85px; left:0px; margin-top:266px;"><div class="head"><?php echo $this->_tpl_vars['l10n']['Actinide']; ?>
</div></div>
		<div class="empty" style="width:85px; left:0px; margin-top:292px;"><div class="head"><?php echo $this->_tpl_vars['l10n']['Superactinide']; ?>
</div></div>
...
" /><span class="pnum"><?php echo $this->_tpl_vars['element']['Z']; ?>
			...
			<?php endif; ?>
				...
				<div class="<?php echo $this->_tpl_vars['element']['TYPE']; ?>
 pick" style="left:<?php echo $this->_tpl_vars['i']*25+$this->_tpl_vars['i']+112; ?>
px; margin-top:240px;"><a title="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['name'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
" href="<?php echo $this->_tpl_vars['element']['ID']; ?>
" class="plink" ><input type="hidden" name="elemid" value="<?php echo $this->_tpl_vars['element']['ID']; ?>
" /><span class="pnum"><?php echo $this->_tpl_vars['element']['Z']; ?>
</span><span class="pname"><?php echo $this->_tpl_vars['element']['ABBR']; ?>
			...
			<?php endif; ?>
				...
				<div class="<?php echo $this->_tpl_vars['element']['TYPE']; ?>
 pick" style="left:<?php echo $this->_tpl_vars['i']*25+$this->_tpl_vars['i']-364+112; ?>
px; margin-top:266px;"><a title="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['name'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
" class="plink" ><input type="hidden" name="elemid" value="<?php echo $this->_tpl_vars['element']['ID']; ?>
" /><span class="pnum"><?php echo $this->_tpl_vars['element']['Z']; ?>
</span><span class="pname"><?php echo $this->_tpl_vars['element']['ABBR']; ?>
</span></a></div> 
			<?php endif; ?> 
				...
				<div class="<?php echo $this->_tpl_vars['element']['TYPE']; ?>
 pick" style="left:<?php echo $this->_tpl_vars['i']*25+$this->_tpl_vars['i']-616; ?>
px; margin-top:292px;"><a title="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['name'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
" class="plink" ><input type="hidden" name="elemid" value="<?php echo $this->_tpl_vars['element']['ID']; ?>
" /><span class="pnum"><?php echo $this->_tpl_vars['element']['Z']; ?>
</span><span class="pname"><?php echo $this->_tpl_vars['element']['ABBR']; ?>
</span></a></div> 
			...
			<?php if ($this->_tpl_vars['element']['ID'] == 2817): ?>
				<div class="<?php echo $this->_tpl_vars['element']['TYPE']; ?>
 pick" style="left:468px; margin-top:240px;"><a title="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['name'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
" href="<?php echo $this->_tpl_vars['element']['ID']; ?>
" class="plink" ><input type="hidden" name="elemid" value="<?php echo $this->_tpl_vars['element']['ID']; ?>
" /><span class="pname_head"><?php echo $this->_tpl_vars['element']['ABBR']; ?>
			...
			<?php if ($this->_tpl_vars['element']['ID'] == 39762): ?>
				<div class="<?php echo $this->_tpl_vars['element']['TYPE']; ?>
 pick" style="left:468px; margin-top:266px;"><a title="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['name'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
" href="<?php echo $this->_tpl_vars['element']['ID']; ?>
" class="plink" ><input type="hidden" name="elemid" value="<?php echo $this->_tpl_vars['element']['ID']; ?>
" /><span class="pname_head"><?php echo $this->_tpl_vars['element']['ABBR']; ?>
</span></a></div> 
