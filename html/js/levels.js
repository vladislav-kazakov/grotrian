...
$.fn.dataTableExt.afnFiltering.push(//energy
    function (oSettings, aData, iDataIndex) {
        ...
        if (aData[0] != confType && confType != '') {
            return false;
        } else if (aData[1] != config && config != '') {
            return false;
        } else if (aData[2] != term && term != '') {
            return false;
        } else if (aData[3] != jvalue && jvalue != '') {
            return false;
        } else if (iMin == "" && iMax == "") {
            return true;
        }
...
//       			},
        ...
        "aoColumns": [
            ...
            */
            ...
            {
                "fnRender": function (oObj) {
                    return isNaN(parseFloat(oObj.aData[5])) ? oObj.aData[5] : parseFloat(oObj.aData[5]);
                }
            },//Energy MHz or Energy
