...
<!--End of Slide-->	       
			...
			<div class="container_12">
				 	<div class="grid_12" id="main">
							<br/>
							<div id="svg"></div>
							<a class="nav" target="_blank" href="/{#$locale#}/newdiagramm/{#$layout_element_id#}">[{#$l10n.Open_in_new_window#}]</a><br/><b>{#$l10n.To_view_a_chart_you_need#} <a href="http://www.adobe.com/svg/viewer/install/main.html" target="_blank">Adobe SVG Viewer</a></b> 
