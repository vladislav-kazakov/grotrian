...
<div class="container_12">
	...
	<div class="grid_10">
		...
		<a href="/{#$locale#}/logout">выход из режима администрирования</a>
	</div>
	...
	<div class="grid_7" id="menu_primary">
		<ul>
			{# if $layout_element_id #}
				...
				<li class="menu_spectra"><input type="hidden" name="section" value="spectrum" /><a href="/{#$interface#}/{#$locale#}/spectrum/{#$layout_element_id#}">{#$l10n.Spectra#}</a></li>
			{#else#}
				...
				<li class="menu_spectra"><input type="hidden" name="section" value="spectrum" /><a href="/{#$interface#}/{#$locale#}/spectrum/">{#$l10n.Spectra#}</a></li>
			{#/if#}
		</ul>
	</div>
