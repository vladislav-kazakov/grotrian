<div class="container_12">
	<div class="grid_12" id="main">   
		<div class="brake"></div>				
		{#if $locale=="ru"#}			
		<h3>{#if $atom.MASS_NUMBER>0#}Изотоп{#elseif $atom.IONIZATION==0#}Атом{#elseif $atom.IONIZATION==-1#}Отрицательный ион{#else#}Ион{#/if#}  {#$atom.NAME_RU_ALT#}, Z={#$atom.Z#}, I.P.={#$atom.IONIZATION_POTENCIAL#} см<sup>-1</sup>, InChI: {#$ichi#}<!--, ichi_key: {#$ichi_key#}--></h3>
		{#else#}
